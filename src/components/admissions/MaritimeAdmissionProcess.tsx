...
const steps = [
  ...
  "Application Verifying and Scrutiny Eligibility Criteria as per DGS Norms",
  "AMET CET 2026 will be conducted at the month of April & May 2026",
  "Preparation of Rank list and shortlisted candidates will be declared in website",
  "Medical Fitness Test for selected candidates as per DGS Norms",
  "Counselling and Information sent to the selected and eligible candidates",
  "Document verification",
  "Provisional admission letter will be sent to the admitted candidates",
];

const MaritimeAdmissionProcess = () => {
  return (
    <Card className="p-6 md:p-8 shadow-md bg-white mb-8">
      <h2 className="text-xl md:text-2xl font-bold text-amet-navy mb-6">
        For Maritime Programmes
      </h2>
...
export default MaritimeAdmissionProcess;
