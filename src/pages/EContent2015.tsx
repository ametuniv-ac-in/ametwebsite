...
const EContent2015 = () => {
  return (
    <Layout title="E-Content 2015-16 | AMET University">
      {/* Hero Section */}
        ...
        <section className="max-w-6xl mx-auto">
          <div className="bg-white rounded-2xl shadow-lg p-8 md:p-12">
            <div className="flex items-center gap-3 mb-8">
              ...
              <h2 className="text-3xl font-bold text-aemet-navy">Academic Year 2015-16</h2>
            </div>
            
            <div className="prose prose-lg max-w-none text-gray-700 space-y-6">
              <p className="text-lg leading-relaxed">
                This section contains the comprehensive list of educational content materials 
                developed during the academic year 2015-16 using the facilities at the 
              ...
              <div className="bg-blue-50 p-6 rounded-lg">
                ...
                <ul className="list-disc list-inside space-y-2 text-gray-700">
                  ...
                  <li>Interactive Educational Materials</li>
                  <li>Digital Learning Resources</li>
                  <li>Multimedia Content for LMS Integration</li>
                </ul>
              </div>

              <p className="text-lg leading-relaxed">
                All materials were created to enhance the learning experience and support 
                the University's digital education initiatives through the uLektz and MyCamu platforms.
              </p>
            </div>
          </div>
        </section>
