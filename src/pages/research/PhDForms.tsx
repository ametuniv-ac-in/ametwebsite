...
const PhDForms = () => {
  const handleDownload = () => {
    ...
    link.href = '/documents/PHD_FORMS_Annexure_1.pdf';
    link.download = 'PHD_FORMS_Annexure_1.pdf';
  ...
  const handleView = () => {
    window.open('/documents/PHD_FORMS_Annexure_1.pdf', '_blank');
  };

  return (
    <ResearchLayout title="PhD Forms">
      <div className="py-6">
              ...
              <div className="flex flex-col items-center justify-center py-8">
                <div className="bg-slate-50 p-8 rounded-lg border-2 border-dashed border-slate-300">
                  ...
                  <p className="text-sm text-muted-foreground text-center mb-6">
                    Official document containing PhD forms at AMET University
                  </p>
