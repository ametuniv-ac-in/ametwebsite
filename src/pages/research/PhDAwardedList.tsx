...
const PhDAwardedList = () => {
  const handleDownload = () => {
    const link = document.createElement('a');
    link.href = '/documents/PhD_Awarded_Annexure_1.pdf';
    link.download = 'PhD_Awarded_Annexure_1.pdf';
  ...
  const handleView = () => {
    window.open('/documents/PhD_Awarded_Annexure_1.pdf', '_blank');
  };

  return (
    <ResearchLayout title="PhD Awarded List">
      <div className="py-6">
              ...
              <div className="flex flex-col items-center justify-center space-y-6 py-8">
                <div className="bg-slate-50 p-8 rounded-lg border-2 border-dashed border-slate-300">
                  ...
                  <p className="text-sm text-muted-foreground text-center mb-6">
                    Official document containing details of PhD degrees awarded by AMET University
                  </p>
