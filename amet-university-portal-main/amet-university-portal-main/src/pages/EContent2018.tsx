...
const EContent2018 = () => {
  return (
    <Layout title="E-Content 2018-19 | AMET University">
      {/* Hero Section */}
        ...
        <section className="max-w-6xl mx-auto">
          <div className="bg-white rounded-2xl shadow-lg p-8 md:p-12">
            <div className="flex items-center gap-3 mb-8">
              ...
              <h2 className="text-3xl font-bold text-aemet-navy">Academic Year 2018-19</h2>
            </div>
            
            <div className="prose prose-lg max-w-none text-gray-700 space-y-6">
              <p className="text-lg leading-relaxed">
                This section contains the comprehensive list of educational content materials 
                developed during the academic year 2018-19 using the facilities at the 
              ...
              <div className="bg-blue-50 p-6 rounded-lg">
                ...
                <ul className="list-disc list-inside space-y-2 text-gray-700">
                  ...
                  <li>Virtual Laboratory Experiences</li>
                  <li>Professional Development Content</li>
                  <li>Cross-disciplinary Programs</li>
                </ul>
              </div>

              <p className="text-lg leading-relaxed">
                The academic year 2018-19 introduced innovative interactive learning approaches 
                and virtual laboratory experiences to enhance student engagement.
              </p>
            </div>
          </div>
        </section>
