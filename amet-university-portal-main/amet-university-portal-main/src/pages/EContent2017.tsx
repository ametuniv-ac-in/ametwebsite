...
const EContent2017 = () => {
  return (
    <Layout title="E-Content 2017-18 | AMET University">
      {/* Hero Section */}
        ...
        <section className="max-w-6xl mx-auto">
          <div className="bg-white rounded-2xl shadow-lg p-8 md:p-12">
            <div className="flex items-center gap-3 mb-8">
              ...
              <h2 className="text-3xl font-bold text-aemet-navy">Academic Year 2017-18</h2>
            </div>
            
            <div className="prose prose-lg max-w-none text-gray-700 space-y-6">
              <p className="text-lg leading-relaxed">
                This section contains the comprehensive list of educational content materials 
                developed during the academic year 2017-18 using the facilities at the 
              ...
              <div className="bg-blue-50 p-6 rounded-lg">
                ...
                <ul className="list-disc list-inside space-y-2 text-gray-700">
                  <li>Specialized Course Content</li>
                  <li>Research Methodology Videos</li>
                  <li>Industry Collaboration Materials</li>
                  <li>Student Project Showcases</li>
                </ul>
              </div>

              <p className="text-lg leading-relaxed">
                The year 2017-18 focused on developing specialized content with industry partnerships 
                and research-oriented educational materials.
              </p>
            </div>
          </div>
        </section>
